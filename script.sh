...
CUDA_VISIBLE_DEVICES=0,1,2,3 python src/vae.py --dataset imagenet --data_path /home/ananya/imagenet/data/imagenet_2012 --seed $(date +%s) --online_ft --denoising --gpus 4 --max_epochs 1600 --val_samples 1 --kl_coeff 0 --log_scale 0 --num_workers 16 --batch_size 128 --warmup_epochs 10 --learning_rate 5e-4
