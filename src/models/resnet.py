...
class ResNetEncoder(nn.Module):
    def __init__(self, block, layers, first_conv3x3=True, remove_first_maxpool=True):
        super().__init__()
...
def resnet18(**kwargs):
    return ResNetEncoder(EncoderBlock, [2, 2, 2, 2], **kwargs)


def resnet50(**kwargs):
    return ResNetEncoder(EncoderBottleneck, [3, 4, 6, 3], **kwargs)
